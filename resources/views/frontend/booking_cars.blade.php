                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="styled_vehicle_card_2 px-0">
                            ...
                            <div class="content_wrapper">
                                <a href="javascript:void(0);">
                                    <h2 class="clr_primary mb-2">Mercedes
                                        SUV
                                        2002</h2>
                                </a>
                                <div>
                                    <ul class="kylist col-xs-12 sddetail">
                                        <li class="f-12 cartip">SUV</li>
                                        <li class="f-13" title="This vehicle has 4 Doors">4
                                            <img alt="Doors" class="svgis"
                                                src="https://www.oneclickdrive.com/application/views/images/door.svg">
                                        </li>
                                        <li title="This vehicle can seat upto 5 Passengers comfortably" class="f-13">5<img
                                                alt="Passengers" class="svgis passenger"
                                                src="https://www.oneclickdrive.com/application/views/images/seat.svg">
                                        </li>
                                        <li title="The boot-space of this vehicle is good for 3 luggage bag(s)"
                                            class="f-13">3<img alt="Large Bags" class="svgis"
                                                src="https://www.oneclickdrive.com/application/views/images/brefcase.svg">
                                        </li>
                                ...
                                <div class="content_container ">
                                    ...
                                    <div class="price_tag mb-0">
                                        <del>AED 200</del>
                                        <span>
                                            <h2 class="clr_primary">AED 100 /
                                                day</h2>
                                            <h2 class="clr_primary">AED 100 / day</h2>
                                        </span>
                                        <span>
                                            <i class="fa fa-road"></i>
                                            <span>299 km</span></span>
                                    </div>
                                    <div class="price_tag ms-0 ms-md-2">
                                        <del>AED 1000</del>
                                        <span>
                                            <h2 class="clr_primary">AED 2 / week</h2>
                                        </span>
                                ...
                                <div class="company_tag d-flex justify-content-between mt-2 flex-wrap">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <img width="50px" src="{{ asset('company_logo/1693916028.png') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div>
