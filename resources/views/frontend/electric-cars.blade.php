...
@section('title', 'Electric Car Rental Dubai | OneTapDrive')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="filterBtnRow">
                        <ul class="linkingCont">
                            ...
                            <li class="javascipt:void(0)"><span> Electric Cars</span></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filterCont">
                        <form method="GET" action="{{ route('rent-hybrid-electrical-cars-dubai') }}">
                            <div id="filters" class="filters">
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100 btnCont">
                                    @php
                                        $currenturl = url()->full();
                                    @endphp
                                    @if ($currenturl != 'https://onetapdrive.com/rent-hybrid-electrical-cars-dubai')
                    ...
                    <div class="container-fluid">
                        <div class="contentArea">
                            <div class="row carRow">
                                ...
                                <div class="col-9">
                                    <div class="filterTags">
                                        ...
                                        @foreach($appliedFilters as $filterName => $filterValue)
                                            @php
                                                // Generate a URL that removes the current filter from the query
                                                $urlWithoutFilter = route(request()->route()->getName(), array_merge(request()->except($filterName)));
                                            @endphp
                                             <a href="{{ $urlWithoutFilter }}" ><button class="filterTag">
                                ...
                                <div class="col-3">
                                    <form id="filterForm" method="GET" action="{{route('rent-hybrid-electrical-cars-dubai')}}">
