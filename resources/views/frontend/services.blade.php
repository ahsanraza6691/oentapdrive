...
@section('title', 'Cheap Car Rental Hire in Dubai | OneTapDrive')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="filterBtnRow">
                        <ul class="linkingCont">
                            ...
                            <li class="current"><span>Rent a car</span></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filterCont">
                        <form method="GET" action="{{ route('rent-a-car-dubai') }}">
                            ...
                            <div class="row carRow">
                                ...
                                <div class="col-9">
                                    ...
                                    @php
                                        ...
                                        $hasActiveFilters = collect($appliedFilters)->filter()->isNotEmpty();
                                    @endphp
                                    ...
                                    @if($hasActiveFilters)
                                        ...
                                        @foreach($appliedFilters as $filterName => $filterValue)
                                            @if(!empty($filterValue))
                                                @php
                                                    // Get the current request parameters without the current filter
                                                    $queryParams = request()->except($filterName);
                                    
                                                    // Generate the URL without the current filter
                                                    $urlWithoutFilter = route(request()->route()->getName(), $queryParams);
                                                @endphp
                               ...
                               <div class="col-3">
                                    <form id="filterForm" method="GET" action="{{route('rent-a-car-dubai')}}">
                                    <div class="inputCont sort">
                                        <select autocomplete="off" name="sort" id="sortSelect">
                                            <option {{ request('sort') == 'featured' ? 'selected' : '' }} selected="selected" value="featured">
                                                Sort: Featured
                                            </option>
                                            <option {{ request('sort') == 'daily_high_to_low' ? 'selected' : '' }} value="daily_high_to_low">
                                                Daily (low to high)
                                            </option>
                                            <option {{ request('sort') == 'daily_low_to_high' ? 'selected' : '' }} value="daily_low_to_high">
                                                Daily (high to low)
                                            </option>
                                            <option {{ request('sort') == 'weekly_low_to_high' ? 'selected' : '' }} value="weekly_low_to_high">
                                                Weekly (low to high)
                                            </option>
                                            <option {{ request('sort') == 'monthly_low_to_high' ? 'selected' : '' }} value="monthly_low_to_high">
                                                Monthly (low to high)
                                            </option>
                                            <option {{ request('sort') == 'passengers_low_to_high' ? 'selected' : '' }} value="passengers_low_to_high">
                                                Passengers (low to high)
                                            </option>
                                            <option {{ request('sort') == 'passengers_high_to_low' ? 'selected' : '' }} value="passengers_high_to_low">
                                            ...
                                            <div class="carCard fullCard serviceCard">
                                                ...
                                                <div class="btnCont">
                                                    ...
                                                    <button data-bs-toggle="modal" data-bs-target="#enquiryModal"
                                                            class="themeBtn enquiry carEnquiry">
                ...
                <div class="col-12">
                    <div class="aboutContent contentWrap">
                        <p>
                            ...
                            OneTapDrive, the hub for luxury car rentals. We have a wide range of
                        ...
                        <p>
                            ...
                            suppliers and finalize the best deal. OneTapDrive ensures quality
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p>
                                            OneTapDrive.com works with several car rental companies across the world.
                                            In
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title fs-5" id="exampleModalLabel">The supplier
                        "{{$details->get_user->company_name ?? ''}}" will directly connect with you</h2>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <h4 id="min_booking">
                                        {{--                                        Minimum {{$details->days}} day(s) booking--}}
                                        Minimum 2 day booking
                                    </h4>
                                    <h4 id="car_company">
                                        {{--                                        {{$details->get_user->company_name ?? ''}} Rent A Car--}}
                                        Al Maseer Rent A Car
                                    </h4>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="inputCont">
                                        ...
                                        <input class="form-control" type="number"
                                               ...
                                               name="contact" placeholder="{{Auth::user()->contact ?? ''}}"
                                               id="number"
                                               required>
                                    </div>
                                    <div class="inputCont checkbox">
                                        <input name="whatsapp_enabled" type="checkbox" value="1" id="whats_enable">
                                    ...
                                    <div class="inputCont">
                                        ...
                                        <input class="form-control" name="email"
                                               ...
                                               type="email" placeholder="{{Auth::user()->email ?? ''}}"
                                               id="email_enq"
                                               required>
                                    </div>
                                    <div class="inputCont checkbox">
                                        <input type="checkbox" value="" id="send_suppliers">
                                        <label class="form-check-label" for="send_suppliers">
                                            Send request to multiple suppliers
                                        </label>
                                    </div>
                                    <div class="inputCont">
                                        <button type="submit" class="themeBtn">Send Enquiry</button>
                                        <p class="mt-3 enq_para" id="text_para">
                                            Your inquiry will be sent to {{$details->get_user->company_name ?? ''}} Rent
                                            A Car without any obligation or cost to you. You agree to be contacted by
                                            OneTapDrive and its partners.
                                        </p>
                                    </div>
                                </div>
                            </div>
