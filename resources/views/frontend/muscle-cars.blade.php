                ...
                <div class="col-md-12">
                    <div class="filterBtnRow">
                        <ul class="linkingCont">
                            ...
                            <li class="javascipt:void(0)"><span>Rent Muscle Cars Dubai</span></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filterCont">
                        <form method="GET" action="{{ route('rent-muscles-cars-in-dubai') }}">
                            <div id="filters" class="filters">
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100 btnCont">
                                    @php
                                        $currenturl = url()->full();
                                    @endphp
                                    @if ($currenturl != 'https://onetapdrive.com/rent-muscles-cars-in-dubai')
                    ...
                    <div class="container-fluid">
                        <div class="contentArea">
                            <div class="row carRow">
                                ...
                                <div class="col-3">
                                    <form id="filterForm" method="GET" action="{{route('rent-muscles-cars-in-dubai')}}">
