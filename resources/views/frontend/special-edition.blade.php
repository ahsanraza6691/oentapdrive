...
@section('title', 'Rent Special Edition Cars in Dubai | Most Luxurious Cars UAE |  OneTapDrive')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filterCont">
                        <form method="GET" action="{{ route('rent-special-edition-car-dubai') }}">
                            <div id="filters" class="filters">
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100 btnCont">
                                    @php
                                        $currenturl = url()->full();
                                    @endphp
                                    @if ($currenturl != 'https://onetapdrive.com/rent-special-edition-car-dubai')
                    ...
                    <div class="container-fluid">
                        <div class="contentArea">
                            <div class="row carRow">
                                ...
                                <div class="col-3">
                                    <form id="filterForm" method="GET" action="{{route('rent-special-edition-car-dubai')}}">
