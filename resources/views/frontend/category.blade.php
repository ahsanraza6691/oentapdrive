            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="filterBtnRow">
                     @php
                    // Assuming the category is always the second segment in the URL, like `/category/suv-car-rentals`
                        $categorySegment = request()->segment(1); // Adjust this based on the segment containing the category
                        $category = $categorySegment ? ucfirst(str_replace('-', ' ', $categorySegment)) : ''; // Default if empty
                    @endphp
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filterCont">
                        <form method="GET" action="{{ route(Route::currentRouteName(), ['type' => request('type', 'default-category')]) }}">
                            ...
                            <div class="row carRow">
                                ...
                                <div class="col-9">
                                    <div class="filterTags">
                                        ...
                                        @php
                                            // Get current request parameters without the current filter
                                            $queryParams = request()->except($filterName);
                                    
                                            // Add the required 'type' parameter to avoid the missing parameter error
                                            $urlWithoutFilter = route(request()->route()->getName(), array_merge(['type' => request('type', 'default-category')], $queryParams));
                                        @endphp
                                ...
                                <div class="col-3">
                                    <form id="filterForm" method="GET" action="{{ route(Route::currentRouteName(), ['type' => request('type', 'default-category')]) }}">
