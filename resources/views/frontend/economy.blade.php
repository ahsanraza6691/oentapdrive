...
@section('title', 'Economy Car Rental Dubai | Best Economy Rent a Car Offers | OneTapDrive')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="filterBtnRow">
                        <ul class="linkingCont">
                            ...
                            <li class="javascipt:void(0)"><span>Economy Car Rental</span></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filterCont">
                        <form method="GET" action="{{ route('rent-cheap-economy-cars-dubai') }}">
                            ...
                            <div class="row carRow">
                                ...
                                <div class="col-9">
                                    <div class="filterTags">
                                        ...
                                        @php
                                            // Create an array of current query parameters
                                            $currentQuery = request()->query();
                                    
                                            // Remove the specific filter from the query parameters
                                            unset($currentQuery[$filterName]); // This removes the current filter
                                    
                                            // Generate a URL with the remaining query parameters
                                            $urlWithoutFilter = route(request()->route()->getName(), $currentQuery);
                                        @endphp
                                        <a href="{{ $urlWithoutFilter }}">
                                            <button class="filterTag">
                                                {{ is_array($filterValue) ? implode(', ', $filterValue) : $filterValue }}
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </a>
                                    @endforeach
                                ...
                                <div class="col-3">
                                    <form id="filterForm" method="GET" action="{{route('rent-cheap-economy-cars-dubai')}}">
