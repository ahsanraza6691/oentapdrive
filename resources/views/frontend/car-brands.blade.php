                ...
                <div class="col-md-12">
                    <div class="filterBtnRow">
                        ...
                        // Assuming the category is always the second segment in the URL, like `/category/suv-car-rentals`
                            $brandSegment = request()->segment(2); // Adjust this based on the segment containing the category
                            $brand = $brandSegment ? ucfirst(str_replace('-', ' ', $brandSegment)) : ''; // Default if empty
                        @endphp
                        <ul class="linkingCont">
                            <li><a href="{{route('home')}}" class="fa fa-home"></a></li>
                            <li><a href="{{route('home')}}">Home</a></li>
                            <li><a href="javascript:void(0);">Dubai</a></li>
                            <li><a href="{{route('brands')}}">Car Brands</a></li>
                            <li class="current"><span>{{ $brand }}</span></li>
                        </ul>
