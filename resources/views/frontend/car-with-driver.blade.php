                                                ...
                                                @foreach ($vehical_type as $type)
                                                    <div class="form-check">
                                                        <div class="checkboxInput">
                                                            <input class="" type="checkbox" name="category[]" value="{{ $type }}" id="{{ $type }}" {{ !empty(request()->get('category')) && in_array($type, request()->get('category')) ? "data-state=checked" : "data-state=unchecked" }} {{ !empty(request()->get('category')) && in_array($type, request()->get('category')) ? "checked" : "" }}>
                                            ...
                                            <div id="carBrands-content" class="collapse_content">
                                                <select name="brand" class="form-control">
                                                    ...
                                                    @foreach ($car_brands as $brand)
                                                        <option value="{{ $brand }}" {{!empty(request()->get("brand")) && request()->get("brand") == $brand ? "data-state=selected" : "data-state=unselected"}} {{!empty(request()->get("brand")) && request()->get("brand") == $brand ? "selected" : ""}}>{{ $brand }}</option>
                                                    @endforeach
                                                </select>
                                                <button class="updateBtn">update</button>
                                            </div>
