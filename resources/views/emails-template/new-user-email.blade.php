																...
																<tr>
																	<td class="text-12 c-grey l-grey a-right py-20"
																		...
																		<a href="#" target="_blank" class="link c-grey"
																			...
																			<span
																				class="link c-grey"
																				style="text-decoration:none; color:#6e6e6e;">View this email in your browser
																			</span>
																		</a>
																	</td>
																</tr>
																							...
																							<tbody>
																								<tr>
																									<td class="img-center p-30 px-15"
																										...
																										<a href="#"
																											target="_blank">
																											<img src="{{asset("email-template-assets/images/logo-2.png")}}"
																												width="300"
																												height="50"
																												border="0"
																												alt="">
																															...
																															<tbody>
																																<tr>
																																	<td class="fluid-img img-center pb-50"
																																		style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px; padding-top: 20px; margin-top: 20px;">
																																		<img src="{{asset("email-template-assets/images/new_user_signup.png")}}"
																																			width="300"
																																			height="300"
																																			border="0"
																																			alt="">
																																...
																																<tr>
																																	<td class="title-36 a-center pb-15"
																																		...
																																		<strong>
                                                                                                                                            New
                                                                                                                                            <span
                                                                                                                                            style="color: #ffba00;"> User Signup!
                                                                                                                                        </span>
																																...
																																<tr>
																																	<td class="text-16 lh-26 a-center pb-25"
																																		...
																																		A new user has signed up! Please log in to the admin portal to review and confirm their account details.
																																	</td>
																																</tr>
